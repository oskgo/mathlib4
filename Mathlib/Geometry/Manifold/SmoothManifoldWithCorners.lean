...
lemma ofSet_mem_analyticGroupoid {s : Set H} (hs : IsOpen s) :
...
lemma symm_trans_mem_analyticGroupoid (e : LocalHomeomorph M H) :
...
lemma mem_analyticGroupoid_of_boundaryless [CompleteSpace E] [I.Boundaryless]
