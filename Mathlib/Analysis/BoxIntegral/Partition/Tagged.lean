...
@[simp]
lemma mem_toPrepartition {π : TaggedPrepartition I} : J ∈ π.toPrepartition ↔ J ∈ π := Iff.rfl
#align box_integral.tagged_prepartition.mem_to_prepartition BoxIntegral.TaggedPrepartition.mem_toPrepartition

@[simp]
lemma mem_mk (π : Prepartition I) (f h) : J ∈ mk π f h ↔ J ∈ π := Iff.rfl
...
@[simp]
lemma iUnion_mk (π : Prepartition I) (f h) : (mk π f h).iUnion = π.iUnion := rfl
#align box_integral.tagged_prepartition.Union_mk BoxIntegral.TaggedPrepartition.iUnion_mk

@[simp]
lemma iUnion_toPrepartition : π.toPrepartition.iUnion = π.iUnion := rfl
...
lemma isPartition_iff_iUnion_eq : IsPartition π ↔ π.iUnion = I :=
...
@[simp]
lemma iUnion_filter_not (π : TaggedPrepartition I) (p : Box ι → Prop) :
...
@[simp]
lemma mem_biUnionTagged (π : Prepartition I) {πi : ∀ J, TaggedPrepartition J} :
...
lemma tag_biUnionTagged (π : Prepartition I) {πi : ∀ J, TaggedPrepartition J} (hJ : J ∈ π) {J'}
...
@[simp]
lemma iUnion_biUnionTagged (π : Prepartition I) (πi : ∀ J, TaggedPrepartition J) :
...
lemma forall_biUnionTagged (p : (ι → ℝ) → Box ι → Prop) (π : Prepartition I)
...
lemma IsPartition.biUnionTagged {π : Prepartition I} (h : IsPartition π)
...
lemma IsPartition.biUnionPrepartition {π : TaggedPrepartition I} (h : IsPartition π)
...
@[simp]
lemma infPrepartition_toPrepartition (π : TaggedPrepartition I) (π' : Prepartition I) :
...
lemma mem_infPrepartition_comm :
...
lemma IsPartition.infPrepartition (h₁ : π₁.IsPartition) {π₂ : Prepartition I}
...
@[simp]
lemma isHenstock_biUnionTagged {π : Prepartition I} {πi : ∀ J, TaggedPrepartition J} :
...
lemma IsHenstock.card_filter_tag_eq_le [Fintype ι] (h : π.IsHenstock) (x : ι → ℝ) :
...
@[simp]
lemma isSubordinate_biUnionTagged [Fintype ι] {π : Prepartition I}
    {πi : ∀ J, TaggedPrepartition J} :
...
lemma IsSubordinate.biUnionPrepartition [Fintype ι] (h : IsSubordinate π r)
...
lemma IsSubordinate.infPrepartition [Fintype ι] (h : IsSubordinate π r) (π' : Prepartition I) :
...
lemma IsSubordinate.mono' [Fintype ι] {π : TaggedPrepartition I} (hr₁ : π.IsSubordinate r₁)
...
lemma IsSubordinate.diam_le [Fintype ι] {π : TaggedPrepartition I} (h : π.IsSubordinate r)
...
@[simp]
lemma mem_single {J'} (hJ : J ≤ I) (h : x ∈ Box.Icc I) : J' ∈ single I J hJ x h ↔ J' = J :=
...
lemma isPartition_single_iff (hJ : J ≤ I) (h : x ∈ Box.Icc I) :
...
lemma isPartition_single (h : x ∈ Box.Icc I) : (single I I le_rfl x h).IsPartition :=
...
lemma forall_mem_single (p : (ι → ℝ) → Box ι → Prop) (hJ : J ≤ I) (h : x ∈ Box.Icc I) :
...
@[simp]
lemma isHenstock_single_iff (hJ : J ≤ I) (h : x ∈ Box.Icc I) :
...
lemma isHenstock_single (h : x ∈ Box.Icc I) : IsHenstock (single I I le_rfl x h) :=
...
@[simp]
lemma isSubordinate_single [Fintype ι] (hJ : J ≤ I) (h : x ∈ Box.Icc I) :
...
@[simp]
lemma iUnion_single (hJ : J ≤ I) (h : x ∈ Box.Icc I) : (single I J hJ x h).iUnion = J :=
...
@[simp]
lemma disjUnion_boxes (h : Disjoint π₁.iUnion π₂.iUnion) :
...
lemma disjUnion_tag_of_mem_left (h : Disjoint π₁.iUnion π₂.iUnion) (hJ : J ∈ π₁) :
...
lemma disjUnion_tag_of_mem_right (h : Disjoint π₁.iUnion π₂.iUnion) (hJ : J ∈ π₂) :
    (π₁.disjUnion π₂ h).tag J = π₂.tag J :=
...
lemma IsSubordinate.disjUnion [Fintype ι] (h₁ : IsSubordinate π₁ r) (h₂ : IsSubordinate π₂ r)
...
lemma IsHenstock.disjUnion (h₁ : IsHenstock π₁) (h₂ : IsHenstock π₂)
...
@[simp]
lemma _root_.BoxIntegral.Prepartition.distortion_biUnionTagged (π : Prepartition I)
    (πi : ∀ J, TaggedPrepartition J) :
...
@[simp]
lemma distortion_biUnionPrepartition (π : TaggedPrepartition I) (πi : ∀ J, Prepartition J) :
...
@[simp]
lemma distortion_single (hJ : J ≤ I) (h : x ∈ Box.Icc I) :
