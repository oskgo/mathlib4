...
lemma Bornology.IsBounded.smul₀ {s : Set E} (hs : IsBounded s) (c : 𝕜) : IsBounded (c • s) :=
...
lemma eventually_singleton_add_smul_subset {x : E} {s : Set E} (hs : Bornology.IsBounded s)
