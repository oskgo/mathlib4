...
lemma _root_.AlgHomClass.unitization_injective' {F R S A : Type*} [CommRing R] [Ring A]
...
lemma _root_.AlgHomClass.unitization_injective {F R S A : Type*} [Field R] [Ring A]
    [Algebra R A] [SetLike S A] [hSA : NonUnitalSubringClass S A] [hSRA : SMulMemClass S R A]
...
lemma unitization_range : (unitization s).range = StarSubalgebra.adjoin R s := by
