...
lemma BddAbove.union [IsDirected α (· ≤ ·)] {s t : Set α} :
...
lemma bddAbove_union [IsDirected α (· ≤ ·)] {s t : Set α} :
...
lemma BddBelow.union [IsDirected α (· ≥ ·)] {s t : Set α} :
...
lemma bddBelow_union [IsDirected α (· ≥ ·)] {s t : Set α} :
...
@[simp]
lemma bddAbove_insert [IsDirected α (· ≤ ·)] {s : Set α} {a : α} :
...
@[simp]
lemma bddBelow_insert [IsDirected α (· ≥ ·)] {s : Set α} {a : α} :
