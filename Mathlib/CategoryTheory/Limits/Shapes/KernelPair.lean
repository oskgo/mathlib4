...
lemma id_of_mono [Mono f] : IsKernelPair f (𝟙 _) (𝟙 _) :=
...
-/
lemma comp_of_mono {f₁ : X ⟶ Y} {f₂ : Y ⟶ Z} [Mono f₂] (small_k : IsKernelPair f₁ a b) :
...
protected lemma pullback {X Y Z A : C} {g : Y ⟶ Z} {a₁ a₂ : A ⟶ Y} (h : IsKernelPair g a₁ a₂)
